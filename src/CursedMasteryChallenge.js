    ...
    <Box textAlign="center" fontSize="xl">
        <Grid minH="100vh">
          ...
          <Heading>Mastery Math: Potions</Heading>
            <Container><p>This page is for strategizing a new style of creature mastery in 4theWords: master Aurilis creatures that drop potion materials (stardust, spellfire, dew berries, knowledge scrolls), then use their drops 
              to make blast or grenade potions and master very high word count monsters. <br></br><br></br>
            </p>
            <br></br>
...
<Accordion allowMultiple>
  ...
  <h2>
    ...
    <AccordionPanel pb={4}>
          ...
          <p>The 10% grenade potion is the primary secret to this strategy. While the 1000-word potion is viable in some circumstances, 
          ...
          Here's a simple glance at how the math works out:
