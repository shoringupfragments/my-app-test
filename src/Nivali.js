...
const calculateDustAllOtherMonstersTotalLoot = {totalDustArdidTotalLoot, totalKirerfQty}
const totalDustAllOtherMonstersLoot = Math.max ((totalDustArdidTotalLoot + totalKirerfQty),0)

const [dustAllOtherMonstersCraft, SetDustAllOtherMonstersCraft] = useState (0);
const calculateDustAllOtherMonstersTotalCraft = {totalDustArdidTotalCraft, totalKirerfQty}
const totalDustAllOtherMonstersCraft = Math.max ((totalDustArdidTotalCraft + totalKirerfQty),0)
...
<Td isNumeric>        {SummaryNoanzaIsShown && <Container>0</Container>}
      ...
      /> <text>Gliva</text>
        ...
        <Td isNumeric>{GlivaQtyIsShown && <Container>{totalGlivaQty}</Container>}
        {KirerfQtyIsShown && <Container>{totalFakeZero}</Container>}
        </Td>
        <Td isNumeric>{GlivaQtyIsShown && <Container>{totalGlivaWC}</Container>}
        {KirerfQtyIsShown && <Container>{totalFakeZero}</Container>}
        </Td>
      </Tr>
      <Tr>
...
<Td isNumeric>{KirerfQtyIsShown && <Container>{totalKirerfQty}</Container>}
{GlivaQtyIsShown && <Container>{totalFakeZero}</Container>}
      </Td>
        <Td isNumeric>{KirerfQtyIsShown && <Container>{totalKirerfWC}</Container>}
        {GlivaQtyIsShown && <Container>{totalFakeZero}</Container>}
        </Td>
      </Tr>
      <Tr>
